#! /bin/bash
# Install openCV 4.11.0 on Ubuntu 22.04 Jammy

#copyright 2025 beomsuchoi

# https://github.com/beomsuchoi/OpenCV_Install_4.11.0
...
custom_echo "GITHUB : github.com/beomsuchoi" "green" # 깃헙 주소 출력
custom_echo "RO:BIT 19th Beomsu Choi" "green"             # 이름 출력
custom_echo "Installing opencv" "green"                  #  설치 정보 출력
...
cmake \
    ...
    -D OPENCV_EXTRA_MODULES_PATH=/home/$USER/opencv/opencv_contrib-4.11.0/modules \
    -D WITH_V4L=ON \
    -D WITH_FFMPEG=ON \
    -D WITH_XINE=ON \
